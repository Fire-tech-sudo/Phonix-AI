...
const Header = () => {
    ...
    return (
        <motion.div className='flex flex-col justify-center items-center text-center my-20'
            ...
            viewport={{ once: true }}
        >
            <motion.div className=' text-stone-500 inline-flex  gap-2 bg-white px-6 py-1 rounded-full border border-neutral-500 w-[290px]'
            ...
            <motion.p
                ...
                animate={{ opacity: 1 }}
                className="mt-2 text-neutral-500">Generated images from imagify</motion.p>
        </motion.div>
    )
}
